                ...
                <div className="flex w-full rounded-lg xl:w-3/4 lg:w-11/12 lg:shadow-xl bg-white bg-opacity-10">
                  <div className="relative hidden w-full bg-cover border-r rounded-l-lg lg:block lg:w-6/12">
                    <div className="relative z-10 m-12 text-left ">
                      ...
                      <div className="w-full mt-10 mb-8 text-base leading-relaxed text-white sm:md:w-3/3 lg:text-1xl "> Creating an account is a one time process to save all your transactions and to keep your preferences saved. You can also join our newsletter to recieve weekly updates on financial updates around the globe.</div>
                    </div>
                  </div>
