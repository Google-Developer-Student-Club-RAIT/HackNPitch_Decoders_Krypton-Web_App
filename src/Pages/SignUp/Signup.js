                  ...
                  <div className="w-full px-8 py-24 bg-gray-500  rounded-lg border-blueGray-100 lg:w-8/12 lg:px-24 lg:py-4 lg:rounded-l-none s">
                    <div className="relative z-10 text-left ">
                      <div className="mt-6">
                        ...
                        <div>
                          <label className="block text-base font-medium leading-relaxed text-blueGray-700">User Name</label>
                        ...
                        <button onClick = {onSignUp}  className="block w-full px-4 py-3 mt-6 font-semibold text-white transition duration-500 ease-in-out transform rounded-lg bg-gradient-to-r from-black hover:from-black to-black focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 hover:to-black">
                            {loading ? 'Give Us A Sec' : "Sign Up"}
                        </button>
                      </div>
                      <p className="mt-8 text-center">Already have an account? <Link to="/login" className="font-semibold text-black hover:text-black">Log In</Link></p>
                    </div>
                  </div>
                </div>
              </div>
